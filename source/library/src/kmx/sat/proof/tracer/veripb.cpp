/// @file library/src/kmx/sat/proof/tracer/veripb.cpp
/// @brief Out-of-line definitions declared by kmx/sat/proof/tracer/veripb.hpp.
/// @copyright Copyright (C) 2026 - present KMX Systems. All rights reserved.
#include <kmx/sat/proof/tracer/veripb.hpp>

namespace kmx::sat::proof::tracer
{
    void veripb::on_event(const proof::proof_event& event) noexcept
    {
        switch (event.kind)
        {
