...
namespace kmx::sat::telemetry
{
    ...
    private:
        ...
        /// @brief Appends one `name=value` field, separated from whatever the line already holds.
        static void append_counter(std::ostringstream& stream, const counter_id id, const counter_t value) noexcept;
