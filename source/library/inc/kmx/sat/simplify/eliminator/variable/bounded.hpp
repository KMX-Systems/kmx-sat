...
namespace kmx::sat::simplify::eliminator::variable
{
    ...
    public:
        ...
        /// @throws None (noexcept).
        void build_resolvents(const kmx::sat::variable var) noexcept
        {
            (void)var;
        }
        ...
        const std::vector<kmx::sat::variable>& eliminated_variables() const noexcept
        {
            return eliminated_variables_;
        }
