...
namespace kmx::sat::telemetry
{
    TEST_CASE("statistics report parser handles malformed tokens and assertion helpers", "[sat]")
    {
        ...
        const auto compact_line =
            "junk conflicts=3 decisions=7 propagations=11 restarts=2 learned_clauses=5 learned_clause_glue_total=9 "
            "learned_clause_glue_samples=3 reduction_passes=2 reduced_clauses=4 deleted_clauses=3 malformed=abc orphan "
            "extra=0";
        ...
        const auto verbose_line =
            ...
            "learned_clause_glue_samples=3 reduction_passes=2 reduced_clauses=4 deleted_clauses=3 terminate_callback_calls=13 "
        ...
        REQUIRE(test_support::compact_statistics_report_has_compact_schema(test_support::parse_statistics_report_line(
            "conflicts=3 decisions=7 propagations=11 restarts=2 learned_clauses=5 learned_clause_glue_total=9 "
            "learned_clause_glue_samples=3 reduction_passes=2 reduced_clauses=4 deleted_clauses=3")));
        ...
        const auto compact_before = test_support::parse_statistics_report_line(
            "conflicts=3 decisions=7 propagations=11 restarts=2 learned_clauses=5 learned_clause_glue_total=9 "
            "learned_clause_glue_samples=3 reduction_passes=2 reduced_clauses=4 deleted_clauses=3");
        const auto compact_after = test_support::parse_statistics_report_line(
            "conflicts=4 decisions=7 propagations=11 restarts=2 learned_clauses=5 learned_clause_glue_total=9 "
            "learned_clause_glue_samples=3 reduction_passes=2 reduced_clauses=4 deleted_clauses=3");
        ...
        REQUIRE(test_support::compact_statistics_report_delta_matches_snapshot_delta(compact_before, compact_after, compact_delta));
        ...
        REQUIRE_FALSE(
            test_support::compact_statistics_report_delta_matches_snapshot_delta(compact_before, compact_after, wrong_compact_delta));

        const auto verbose_before = test_support::parse_statistics_report_line(
            "conflicts=3 decisions=7 propagations=11 restarts=2 learned_clauses=5 learned_clause_glue_total=9 "
            "learned_clause_glue_samples=3 reduction_passes=2 reduced_clauses=4 deleted_clauses=3 terminate_callback_calls=13 "
            "learn_callback_calls=17 external_propagator_calls=19 option_updates=23 configuration_updates=29");
        const auto verbose_after = test_support::parse_statistics_report_line(
            "conflicts=4 decisions=7 propagations=11 restarts=2 learned_clauses=5 learned_clause_glue_total=9 "
            "learned_clause_glue_samples=3 reduction_passes=2 reduced_clauses=4 deleted_clauses=3 terminate_callback_calls=13 "
        ...
        REQUIRE(test_support::verbose_statistics_report_delta_matches_snapshot_delta(verbose_before, verbose_after, verbose_delta));
        ...
        REQUIRE_FALSE(
            test_support::verbose_statistics_report_delta_matches_snapshot_delta(verbose_before, verbose_after, wrong_verbose_delta));
