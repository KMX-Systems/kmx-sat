...
namespace kmx::sat::io::fixture
{
    ...
    TEST_CASE("manifest", "[sat]")
    {
        ...
        value.set_normalization_profile(normalization_profile_id::dedup_tautology_drop);
        ...
        REQUIRE(value.normalization_profile() == normalization_profile_id::dedup_tautology_drop);
