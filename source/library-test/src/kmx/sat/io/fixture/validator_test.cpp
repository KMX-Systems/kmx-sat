...
namespace kmx::sat::io::fixture
{
    ...
    TEST_CASE("validator", "[sat]")
    {
        ...
        const literal x_pos {variable {1}, false};
        const literal y_neg {variable {2}, true};
        const literal z_pos {variable {3}, false};

        schema cnf_schema;
        cnf_schema.set_payload_kind(schema::payload_kind::cnf_fixture);

        validator cnf_validator;
        validator::clause_container clauses {{x_pos, y_neg}, {z_pos}};
        cnf_validator.set_declared_variable_count(3);
        ...
        validator::clause_container out_of_domain_clauses {{literal {variable {4}, false}}};
        bad_domain.set_declared_variable_count(3);
        ...
        validator bad_shape;
        validator::clause_container malformed_clauses {{}, {x_pos}};
        bad_shape.set_declared_variable_count(3);
        ...
        request_validator.set_declared_variable_count(3);
